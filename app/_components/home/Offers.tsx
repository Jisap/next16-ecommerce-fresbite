...
const Offers = () => {
  return (
    <EntranceAnimation
      ...
      scrollTrigger
      scrollStart="top 85%"
      className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 px-2 items-center lg:px-8 xl:px-12 gap-2 py-12"
    >
      <div className='banner-item text-white p-8 lg:p-10 rounded-xl h-full flex flex-col justify-between'>
        ...
        <Link href="/" className='text-secondary font-medium text-md capitalize cursor-pointer mt-4'>View Offers</Link>
      </div>
