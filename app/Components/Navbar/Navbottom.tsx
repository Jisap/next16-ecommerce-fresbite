...
const Navbottom = () => {
  ...
  return (
    <>
      <div className="nav-bottom lg:px-8 xl:px-12 w-full lg:flex hidden py-2 bg-white">
        <div className="w-full bg-prim rounded-xl shadow-lg flex justify-between items-center px-4 py-2.5">
          {/* Shop by categories */}
          <div className="relative w-[22%]">
            <button
              onClick={() => setCatOpen(!catOpen)}
              className="w-full bg-prim text-white py-2 px-4 rounded-lg flex justify-between items-center cursor-pointer font-semibold transition-all duration-300 hover:bg-prim-dark"
            >
